...
# Step 3: Download
ARGOCD_CLI_NAME=argocd-${OS_ARCH}-amd64
ARGOCD_CLI_URL="https://github.com/argoproj/argo-cd/releases/download/${ARGOCD_VERSION}/${ARGOCD_CLI_NAME}"
...
if [ -f ${ARGOCD_CLI_FILE} ]; then
  ...
  curl -L "${ARGOCD_CLI_URL}" -o "${ARGOCD_CLI_HOME}/${ARGOCD_CLI_NAME}"
...
ARGOCD_CLI=${ARGOCD_CLI_HOME}/${ARGOCD_CLI_NAME}
